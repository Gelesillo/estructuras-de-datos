...
$(IntermediateDirectory)/Persona.cpp$(ObjectSuffix): Persona.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/ivang/OneDrive/Documentos/EstructurasDeDatos/Persona.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Persona.cpp$(ObjectSuffix) $(IncludePath)
